...
# left_join : row month -> repeating the month  
summary(BR_complete)

#not dropping the data rather interpolation
...
#s.window: find your seasonal component 
...
# temp trend maps with the original plot? (need to convert into data frame for ggplot)

BR_Rain_Components <- 
  as.data.frame((BR_Rain_Decomposed),
