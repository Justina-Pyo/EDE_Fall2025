...
>Answer: data itself has different characters
...
ggplot(data = USGS.flow.data, aes(x = discharge.mean.approval)) +
  geom_bar()
#aes: x is from certain column
#discharge: catergorical 
#geom: bar is created
```
...
#grouping (binwidth starts with 0)
# 
ggplot(USGS.flow.data) +
...
#violion : width: proportional (frequency)
ggplot(USGS.flow.data) +
...
> Answer: There are a lot of outliars.
